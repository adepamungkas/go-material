...
func init() {
	...
	db, err = gorm.Open("mysql", "doadmin:k8bxpa54neic0gd5@db-mysql-sgp1-09976-do-user-8830210-0.b.db.ondigitalocean.com:25060/defaultdb?ssl-mode=REQUIRED&charset=utf8&parseTime=True&loc=Local")
